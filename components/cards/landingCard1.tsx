...
const LandingCard1 = () => {
  return (
    ...
    h-full md:h-[15rem] lg:h-[18rem] xl:h-[15rem] backdrop-blur-md bg-[#00FFA3]/10 shadow-md flex flex-col">
      <div className="relative">
        ...
        <div>
          ...
          <p className="mb-2 whitespace-nowrap text-lg md:text-2xl lg:text-2xl xl:text-3xl font-bold">
            0000.081
            <span className="text-sm xl:text-xl text-[#FCED2F]">{" "}BTC </span>
          </p>
          <div className="flex">
