    ...
    <div className="flex flex-col items-center text-white dark:text-white ">
      ...
      >
        <div className="2xl:col-span-5 xl:col-span-5  md:col-span-1 sm:col-span-1">
          <h1 className="text-xl font-benzin xs:text-2xl  sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-4xl 3xl:text-7xl 4xl:text-9xl leading-tight  font-bold custom-font">
          ...
          <div className="grid mt-10 min-h-fit grid-cols-2 2xl:grid-cols-2 xl:grid-cols-2 md:grid-cols-2 gap-y-2  3xl:py-[2rem] 4xl:py-[3rem]">
            ...
            <Tilt scale={scale} transitionSpeed={2500}>
              ...
              <div className="flex h-full justify-center">
                <Image
                  ...
                  height="0"
                  sizes="100vw"
                  className="w-[80%] h-auto aspect-square self-center"
                />
              </div>
            </Tilt>
            {/* </div> */}
              ...
              <div className="grid gap-1 sm:gap-2 md:gap-3 3xl:gap-14 ">
                <div className="grid md:grid-cols-2 md:gap-x-4">
                  ...
                  <div className="flex items-center">
                    <p className="font-poppins text-xs xs:text-sm sm:text-xl md:text-lg xl:text-lg 2xl:text-xl 3xl:text-3xl 4xl:text-5xl font-medium leading-4 sm:leading-6 lg-leading-tight 4xl:leading-normal ">
                      Join The Growing Community
                    </p>
                  </div>
                </div>
                <p className=" font-poppins italic text-xs xs:text-sm sm:text-xl md:text-xl  2xl:text-2xl 3xl:text-3xl 4xl:text-5xl leading-4 sm:leading-6 lg-leading-tight">
                  Swap directly with any one
                </p>
                <p className="font-extralight font-poppins text-[9px] xs:text-sm sm:text-base md:text-lg  2xl:text-xl 3xl:text-3xl 4xl:text-5xl leading-3 sm:leading-4 3xl:leading-tight">
        ...
        <div className="2xl:col-span-3 xl:col-span-3 md:col-span-1 sm:col-span-1 relative">
